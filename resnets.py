...
class ResNet(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv2d(
            3, num_out_filters, kernel_size=k, stride=s, padding=p, bias=False
        )
...
def resnet18w2(**kwargs):
    return ResNet(Bottleneck, [2, 2, 2, 2], widen=2, **kwargs)


def resnet18w4(**kwargs):
    return ResNet(Bottleneck, [2, 2, 2, 2], widen=4, **kwargs)
...
def cifar10_resnet18(**kwargs):
    return resnet18(is_cifar10=True, **kwargs)


def cifar10_resnet18w2(**kwargs):
    return resnet18w2(is_cifar10=True, **kwargs)


def cifar10_resnet18w4(**kwargs):
    return resnet18w4(is_cifar10=True, **kwargs)


def cifar10_resnet50(**kwargs):
    return resnet50(is_cifar10=True, **kwargs)


def cifar10_resnet50w2(**kwargs):
    return resnet50w2(is_cifar10=True, **kwargs)


def cifar10_resnet50w4(**kwargs):
    return resnet50w4(is_cifar10=True, **kwargs)


def cifar10_resnet101(**kwargs):
    return resnet101(is_cifar10=True, **kwargs)


def cifar10_resnet101w2(**kwargs):
    return resnet101w2(is_cifar10=True, **kwargs)


def cifar10_resnet151(**kwargs):
    return resnet151(is_cifar10=True, **kwargs)


def cifar10_resnet151w2(**kwargs):
    return resnet151w2(is_cifar10=True, **kwargs)


def cifar10_resnet200(**kwargs):
    return resnet200(is_cifar10=True, **kwargs)


def cifar10_resnet200w2(**kwargs):
    return resnet200w2(is_cifar10=True, **kwargs)